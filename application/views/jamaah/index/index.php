            ...
            <div class="card planned_task">
                ...
                <div class="body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a class="btn float-right text-white" style="background-color: #008080!important;" href="<?php echo site_url('jamaah/index/tambah') ?>"><i class="fa fa-plus"></i> Tambah Data jamaah</a>
                        </div>
                    </div><br>
                    <div class="container">
